...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                visitedViews: state => state.global.visitedViews
            })
        },
        watch: {
            $route() {
        ...
        methods: {
            ...mapActions({
                addVisitedViews: "global/addVisitedViews",
                delVisitedViews: "global/delVisitedViews",
                delOthersViews: "global/delOthersViews",
                delAllViews: "global/delAllViews"
            }),
            isActive(route) {
            ...
            closeOthersTags() {
                this.$router.replace(this.selectedTag.path)
